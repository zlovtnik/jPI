...
class AuditService {
    ...
    fun logMemberCreated(memberData: Any): Either<AuditError, AuditResult> = try {
    ...
    fun logDonationCreated(donationData: Any): Either<AuditError, AuditResult> = try {
    ...
    fun logEmailSent(emailData: Any): Either<AuditError, AuditResult> = try {
    ...
    fun logError(errorData: Any): Either<AuditError, AuditResult> = try {
    ...
    fun logUserAuthentication(username: String, success: Boolean): Either<AuditError, AuditResult> = try {
