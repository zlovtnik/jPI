...
class EmailService(
    ...
    fun sendBulkEmails(emails: List<EmailRequest>): Either<EmailError, List<EmailResult>> =
        try {
            runBlocking {
    ...
    private fun buildDonationThankYouBody(
        member: Member,
        amount: String,
    ): String =
        """
