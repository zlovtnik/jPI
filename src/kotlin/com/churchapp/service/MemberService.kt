...
class MemberService(
    ...
    fun findById(id: UUID): Either<MemberError, Member> =
        try {
    ...
    fun findByEmailOption(email: String): Option<Member> =
        try {
    ...
    fun getActiveMembers(): Either<MemberError, List<Member>> =
        try {
